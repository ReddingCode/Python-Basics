...
def recuperer_infos_personne(numero_personne):
    ...
    try:
        ...
        print("Erreur: Vous devez rentrer un age valide")
        return recuperer_et_afficher_infos_personne(numero_personne)
    return nom_personne, int(age_personne)


def afficher_infos_personne(numero_personne, nom, age: int):
    print("La personne", numero_personne,
          "est", nom, "son age est", age, "ans")
